...
| Завантажені картинки       | KV (R2 треба вмикати вручну)          |
...
## Кроки 1–2 — ВЖЕ ЗРОБЛЕНО ✅

- D1 база `slv-visual` створена (`5b75f1f9-…`, регіон EEUR), схема залита
- Дані перенесені: 4 проєкти, 3 учасники команди
- KV-сховище `slv-visual-uploads` створене для нових завантажень
- Worker розгорнутий і перевірений: https://slv-visual.666anonim-on.workers.dev

R2 лишився невикористаним: його треба вмикати вручну в панелі, а KV на
безкоштовному тарифі доступний одразу і для кількох обкладинок його вистачає
з запасом (1 ГБ, 1000 записів/добу).
